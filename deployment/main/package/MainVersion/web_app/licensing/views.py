...
from core.edition_utils import database_file_name, get_edition_name, is_tax_enabled
...
def index(request):
    ...
    return render(
        ...
        "licensing/license_status.html",
        {
            ...
            "tax_enabled_status": is_tax_enabled(request=request, company_id=company_id),
