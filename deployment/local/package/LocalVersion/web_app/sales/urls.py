...
urlpatterns = [
    ...
    path("quotations/<int:quotation_id>/letterhead-print/", views.letterhead_print_quotation, name="quotation_letterhead_print"),
    path("quotations/<int:quotation_id>/letterhead-pdf/", views.letterhead_pdf_quotation, name="quotation_letterhead_pdf"),
    ...
    path("invoices/<int:invoice_id>/letterhead-print/", views.letterhead_print_invoice, name="invoice_letterhead_print"),
    path("invoices/<int:invoice_id>/letterhead-pdf/", views.letterhead_pdf_invoice, name="invoice_letterhead_pdf"),
    ...
    path("returns/customer/<int:customer_id>/invoices/", views.sales_return_customer_invoices, name="return_customer_invoices"),
    path("returns/invoice/<int:invoice_id>/items/", views.sales_return_invoice_items, name="return_invoice_items_detail"),
